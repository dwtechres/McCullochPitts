...
if __name__ == "__main__":
	...
	x_train = numpy.array([[0], [1]], dtype=numpy.float32)
	y_train = numpy.array([[1], [0]], dtype=numpy.float32)

	# Define the weights for the McCullochPitts layer
	weights = numpy.array([[1]], dtype=numpy.float32)

	input = tensorflow.keras.Input(shape=(1,))
	mcp = model.McCullochPitts(units=1, theta=1, weights=weights, comparison_op='less')(input)
